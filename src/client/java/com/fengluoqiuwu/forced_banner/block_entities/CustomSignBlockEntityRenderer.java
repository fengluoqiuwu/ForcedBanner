...
public class CustomSignBlockEntityRenderer implements BlockEntityRenderer<SignBlockEntity> {
    ...
    private final Map<WoodType, net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel> typeToModel;
    private final TextRenderer textRenderer;

    public CustomSignBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.typeToModel = (Map)WoodType.stream().collect(ImmutableMap.toImmutableMap((signType) -> signType, (signType) -> new net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel(ctx.getLayerModelPart(EntityModelLayers.createSign(signType)))));
    ...
    public void render(SignBlockEntity signBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        ...
        net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel signModel = (net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel)this.typeToModel.get(woodType);
    ...
    void renderSignModel(MatrixStack matrices, int light, int overlay, Model model, VertexConsumer vertexConsumers) {
        net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel signModel = (net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel)model;
    ...
    void renderText(BlockPos pos, SignText signText, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int lineHeight, int lineWidth, boolean front) {
        ...
        for(int m = 0; m < 4; ++m) {
            ...
            if (bl) {
                ...
                this.textRenderer.draw(orderedText, f, (float)(m * lineHeight - j), k, false, matrices.peek().getPositionMatrix(), vertexConsumers, TextLayerType.POLYGON_OFFSET, 0, l);
            }
        }
    ...
    public static net.minecraft.client.render.block.entity.SignBlockEntityRenderer.SignModel createSignModel(EntityModelLoader entityModelLoader, WoodType type) {
