...
public class CustomSignBlockEntityRenderer implements BlockEntityRenderer<SignBlockEntity> {
    ...
    private final Map<WoodType, CustomSignBlockEntityRenderer.SignModelPair> typeToModelPair;
    private final TextRenderer textRenderer;

    public CustomSignBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.typeToModelPair = (Map<WoodType, CustomSignBlockEntityRenderer.SignModelPair>)WoodType.stream()
                .collect(
                        ImmutableMap.toImmutableMap(
                                signType -> signType,
                                signType -> new CustomSignBlockEntityRenderer.SignModelPair(
    ...
    public void render(SignBlockEntity signBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        ...
        CustomSignBlockEntityRenderer.SignModelPair signModelPair = (CustomSignBlockEntityRenderer.SignModelPair)this.typeToModelPair.get(woodType);
