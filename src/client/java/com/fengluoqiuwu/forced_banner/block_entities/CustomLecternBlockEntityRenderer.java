...
public class CustomLecternBlockEntityRenderer implements BlockEntityRenderer<LecternBlockEntity> {
    private final BookModel book;

    public CustomLecternBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
