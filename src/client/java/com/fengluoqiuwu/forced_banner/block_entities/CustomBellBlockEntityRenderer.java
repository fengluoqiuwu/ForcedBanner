...
public class CustomBellBlockEntityRenderer implements BlockEntityRenderer<BellBlockEntity> {
    public static final SpriteIdentifier BELL_BODY_TEXTURE;
    private static final String BELL_BODY = "bell_body";
    private final ModelPart bellBody;

    public CustomBellBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
