...
public class CustomBrushableBlockEntityRenderer implements BlockEntityRenderer<BrushableBlockEntity> {
    private final ItemRenderer itemRenderer;

    public CustomBrushableBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
