...
public class CustomConduitBlockEntityRenderer implements BlockEntityRenderer<ConduitBlockEntity> {
    ...
    public CustomConduitBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
